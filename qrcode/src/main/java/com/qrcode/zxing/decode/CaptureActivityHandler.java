...
package com.qrcode.zxing.decode;
...
import com.qrcode.zxing.view.ViewfinderResultPointCallback;
 ...
 * qrcode_activity_capture_layout.
 *
...
public final class CaptureActivityHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        if (message.what == R.id.qrcode_auto_focus) {
            ...
            // start another.
            state = State.PREVIEW;
            CameraManager.get().requestPreviewFrame(decodeThread.getHandler(), R.id.qrcode_decode);
