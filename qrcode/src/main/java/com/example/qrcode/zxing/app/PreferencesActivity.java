...
public final class PreferencesActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener
{
	...
	public static final String KEY_PLAY_BEEP = "qrcode_preferences_play_beep";
	public static final String KEY_VIBRATE = "qrcode_preferences_vibrate";
	...
	protected void onCreate(Bundle icicle)
	{
		...
		addPreferencesFromResource(R.xml.qrcode_preferences);
