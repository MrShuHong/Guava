...
package com.example.qrcode.zxing.encode;
...
import com.example.qrcode.zxing.decode.Contents;
    ...
    private boolean encodeContentsFromZXingIntent(Intent intent) {
        ...
        if (format == null || BarcodeFormat.QR_CODE.equals(format)) {
            ...
            if (data != null && data.length() > 0) {
                ...
                title = activity.getString(R.string.qrcode_contents_text);
            }
        }
    ...
    private void encodeQRCodeContents(Intent intent, String type) {
        if (type.equals(Contents.Type.TEXT)) {
            ...
            if (data != null) {
                ...
                displayContents = data;
                title = activity.getString(R.string.qrcode_contents_email);
            }
            ...
            if (data != null) {
                ...
                title = activity.getString(R.string.qrcode_contents_phone);
            }
            ...
            if (data != null) {
                contents = "sms:" + data;
                displayContents = PhoneNumberUtils.formatNumber(data);
                title = activity.getString(R.string.qrcode_contents_sms);
            }
            ...
            if (bundle != null) {
                ...
                if (newDisplayContents.length() > 0) {
                    ...
                    title = activity.getString(R.string.qrcode_contents_contact);
                } else {
                    contents = null;
            ...
            if (bundle != null) {
                ...
                if (latitude != Float.MAX_VALUE && longitude != Float.MAX_VALUE) {
                    ...
                    title = activity.getString(R.string.qrcode_contents_location);
                }
            }
        }
    }
