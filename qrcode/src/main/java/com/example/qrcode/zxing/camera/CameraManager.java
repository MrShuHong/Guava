...
import com.example.qrcode.zxing.app.PreferencesActivity;
import com.example.qrcode.zxing.decode.PlanarYUVLuminanceSource;
...
public final class CameraManager {
    ...
    private CameraManager(Context context) {
        ...
        MIN_FRAME_WIDTH = (int) Util.dip2px(context, 180);
        MIN_FRAME_HEIGHT = (int) Util.dip2px(context, 180);
        MAX_FRAME_WIDTH = (int) Util.dip2px(context, 240);
        MAX_FRAME_HEIGHT = (int) Util.dip2px(context, 240);
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
        ...
        switch (previewFormat) {
            ...
            case PixelFormat.YCbCr_422_SP:
                //The content of the camera image is not cut. 不裁剪相机返回的图像内容，优化近距离扫码速度
